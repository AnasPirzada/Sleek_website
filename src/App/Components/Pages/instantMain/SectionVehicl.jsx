...
const SectionVehicl = () => {
  ...
  console.log("xdfsrfeasrsdrsdgsgsdg", storedselectedDate);
  console.log("xdfsrfeasrsdrsdgsgsdgselect", selectedDate);
  ...
  useEffect(() => {
    ...
    if (storedselectedDate) {
      setstoredselectedDate(JSON.parse(storedselectedDate));
    }
  }, []);
