...
const SectionVehicl = () => {
  ...
  // const stairsOptions = [
  //   {
  //     label: 'Please Select STAIRS Value',
  //     value: 'Please Select STAIRS Value',
  //   },
  //   {
  ...
  // // Start Session storage Stored values
  ...
  // const [storedSelectedWeekDate, setStoredSelectedWeekDate] = useState(null); // New state for stored SelectedWeekDate
  // // end

  // // showing session storage values in state in initial state will be empty when value is added in session storage it will be added
  // const [email, setEmail] = useState(storedEmail || '');
  // const [name, setName] = useState('');
  // const [phone, setPhone] = useState('');
  // const [selectedVehicle, setSelectedVehicle] = useState('');
  // const [selectedDeliveryHelp, setSelectedHelp] = useState('');
  // const [activeOptionYouHaveLIFTS, setActiveYouHaveLIFTSOption] = useState(null);
  // const [EmailTextNeedactiveOption, setEmailTextNeedactiveOption] = useState('');
  ...
  // const [healthValues, setHealthValues] = useState(getAllSessionStorageValues());

  // const hoursOptions = [
  //   { label: 'Select The Time', value: 'Select The Time' },
  ...
  //     { field: selectedVehicle, name: 'Selected vehicle', errorMessage: 'Please select a vehicle.' },
  //     { field: selectedDeliveryHelp, name: 'Delivery Help', errorMessage: 'Please select a delivery help option.' },
  //     { field: deliveryValues, name: 'Delivery Values', errorMessage: 'Please provide Delivery address values.' },
  //     { field: selectedStairsValue, name: 'Delivery STAIRS', errorMessage: 'Please provide delivery stairs information.' },
  //     { field: healthValues, name: 'Collection Address', errorMessage: 'Please provide a Pickup address.' },
  //     { field: selectedValue, name: 'PICK UP STAIRS', errorMessage: 'Please provide pick up stairs information.' },
  //     { field: activeOptionYouHaveLIFTS, name: 'DO YOU HAVE LIFTS', errorMessage: 'Please specify if you have lifts.' },
  //     { field: selectedVehicleDuration, name: 'Selected vehicle duration', errorMessage: 'Please select a vehicle duration.' },
  //     { field: selectedDate, name: 'Selected Date', errorMessage: 'Please select a date.' },
  //     { field: selectedTime, name: 'Selected Time', errorMessage: 'Please select a time.' },
  //     { field: Description, name: 'Description', errorMessage: 'Please provide a description.' },
  //     { field: name, name: 'Name', errorMessage: 'Please enter your name.' },
  //     { field: email, name: 'Email', errorMessage: 'Please enter your email.' },
  //     { field: phone, name: 'Phone', errorMessage: 'Please enter your phone number.' },
  //     { field: EmailTextNeedactiveOption, name: 'Email&Text Need', errorMessage: 'Please specify email and text needs.' },
  //   ];
  ...
  //   sessionStorage.setItem('deliveryValues', JSON.stringify(selectedDeliveryHelp));
  //   sessionStorage.setItem('Delivery Address :', JSON.stringify(deliveryValues));
  //   sessionStorage.setItem('DeliverySTAIRS', JSON.stringify(selectedStairsValue));
  ...
  //   sessionStorage.setItem('YouHaveLIFTS', JSON.stringify(activeOptionYouHaveLIFTS));
  //   sessionStorage.setItem('selectedVehicleDuration', JSON.stringify(selectedVehicleDuration));
  //   sessionStorage.setItem('selectedDate', JSON.stringify(selectedDate));
  //   // sessionStorage.setItem('SelectedWeekDate', JSON.stringify(SelectedWeekDate)); // Store SelectedWeekDate
  ...
  //   sessionStorage.setItem('EmailTextNeed', JSON.stringify(EmailTextNeedactiveOption));
  ...
  // const { distanceInMiles, pickupLocation, deliveryLocation } = location.state || {
  //   distanceInMiles: 0,
  //   pickupLocation: {},
  //   deliveryLocation: {},
  // };
  ...
  //   const storedSelectedWeekDate = sessionStorage.getItem('SelectedWeekDate'); // Retrieve stored SelectedWeekDate

  //   if (storedselectedDate) {
  //     setSelectedDate(JSON.parse(storedselectedDate));
  //   }
  //   if (storedselectedTime) {
  //     setSelectedTime(JSON.parse(storedselectedTime));
  //   }
  //   if (storedSelectedWeekDate) {
  //     setStoredSelectedWeekDate(JSON.parse(storedSelectedWeekDate));
  //   }
  // }, []);
  ...
  //   sessionStorage.setItem('selectedTime', JSON.stringify(timeValue));
  // };
  ...
  //   sessionStorage.setItem('selectedDate', JSON.stringify(dateValue));
  // };

  // useEffect(() => {
  //   // Update SelectedWeekDate whenever selectedDate or dayType changes
  //   const date = new Date(selectedDate);
  //   const day = date.getDay();
  //   const currentDayType = day === 0 || day === 6 ? 'Weekend' : 'Weekday';
  //   const formattedSelectedWeekDate = `${currentDayType}: ${date.toLocaleDateString()}`;

  //   setStoredSelectedWeekDate(formattedSelectedWeekDate);
  //   sessionStorage.setItem('SelectedWeekDate', JSON.stringify(formattedSelectedWeekDate));
  ...
  // useEffect(() => {
  //   const storedDeliveryStreetAddress = sessionStorage.getItem('deliveryStreetAddress');
  //   const storedDeliveryPostalCode = sessionStorage.getItem('deliveryPostalCode');
  ...
  //   const storedselectedVehicleDuration = sessionStorage.getItem('selectedVehicleDuration');
  //   const storedselectedstoredDescription = sessionStorage.getItem('Description');
  //   const storedselectedstoredEmailTextNeed = sessionStorage.getItem('EmailTextNeed');
  //   const storedSelectedWeekDate = sessionStorage.getItem('SelectedWeekDate'); // Retrieve stored SelectedWeekDate
  ...
  //   if (storedName) {
  //     setStoredName(JSON.parse(storedName));
  ...
  //   if (storedSelectedWeekDate) {
  //     setStoredSelectedWeekDate(JSON.parse(storedSelectedWeekDate)); // Set the state with the retrieved value
  //   }
  // }, []);
  ...
  const [isStairsDisabled, setIsStairsDisabled] = useState(false);
  ...
  const handleGetQuotes = () => {
    ...
    const requiredFields = [
      ...
      {
        field: selectedDeliveryHelp,
        name: 'Delivery Help',
        errorMessage: 'Please select a delivery help option.',
      },
      {
        field: deliveryValues,
        name: 'Delivery Values',
        errorMessage: 'Please provide Delivery address values.',
      },
      {
        field: selectedStairsValue,
        name: 'Delivery STAIRS',
        errorMessage: 'Please provide delivery stairs information.',
      },
      {
        field: healthValues,
        name: 'Collection Address',
        errorMessage: 'Please provide a Pickup address.',
      },
      {
        field: selectedValue,
        name: 'PICK UP STAIRS',
        errorMessage: 'Please provide pick up stairs information.',
      },
      {
        field: activeOptionYouHaveLIFTS,
        name: 'DO YOU HAVE LIFTS',
        errorMessage: 'Please specify if you have lifts.',
      },
      {
        field: selectedVehicleDuration,
        name: 'Selected vehicle duration',
        errorMessage: 'Please select a vehicle duration.',
      },
      {
        field: selectedDate,
        name: 'Selected Date',
      ...
      {
        field: EmailTextNeedactiveOption,
        name: 'Email&Text Need',
        errorMessage: 'Please specify email and text needs.',
      },
    ];
  ...
  useEffect(() => {
    ...
    sessionStorage.setItem(
      'SelectedWeekDate',
      JSON.stringify(formattedSelectedWeekDate)
    );
  }, [selectedDate, dayType]);
      ...
      <section className='px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-[135px]  overflow-x-hidden '>
        ...
        <div>
          <div className='mt-8'>
            ...
            <p className='mt-2  text-[#E97B08] '>
              Click on Edit to Add Door/Flat Number
            </p>
          </div>
        ...
        <div className='pt-6 '>
          ...
          <div className='w-full '>
            <select
              name='vehicle'
              id='vehicle'
              className='w-40 h-[40px] bg-[#ECECEC] rounded-lg'
